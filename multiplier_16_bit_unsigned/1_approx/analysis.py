...
for i in range(0, op_len):
    for j in range(0, op_len):
        #   Calcolo dell'errore assoluto tra il risultato della moltiplicazione approssimata e il risultato 
        #   della moltiplicazione esatta tra i due numeri i e j
        diff = abs(mul16u_9M4.mul(i,j) - (i*j))
        ...
        if i > 0 and j > 0:
            ...
            diff_rel = abs(mul16u_9M4.mul(i,j) - (i*j))/(i*j)
...
if e_count > 0:
    ...
    print('mean_absolute_error (MAE) = ', 0)
